...
class LorBalancer:
    def __init__(self, prefill_configs: List[PrefillConfig], decode_servers: List[str]):
        ...
        self.prefill_bootstrap_map = {p.url: p.bootstrap_port for p in prefill_configs}
        self.prefill_cnt_lock = asyncio.Lock()
    ...
    def add_prefill_server(self, new_prefill_config: PrefillConfig):
        ...
        self.prefill_bootstrap_map[new_prefill_config.url] = new_prefill_config.bootstrap_port
        if new_prefill_config.url not in self.prefill_cnt.keys():
            self.prefill_cnt[new_prefill_config.url] = 0
...
app = FastAPI()
load_balancer: Optional[LorBalancer] = None
